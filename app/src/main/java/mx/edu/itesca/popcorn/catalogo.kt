...
class catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        peliculas.add(Pelicula("Big Hero 6", R.drawable.bighero6,R.drawable.headerbighero6,"When a devastating event befalls the city of San Fransokyo and catapults Hiro into the midst of danger, he turns to Baymax and his close friends adrenaline junkie Go Go Tomago, neatnik Wasabi, chemistry whiz Honey Lemon and fanboy Fred. Determined to uncover the mystery, Hiro transforms his friends into a band of high-tech heroes called" ,arrayListOf()))
    ...
    class PeliculaAdapter: BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            image.setOnClickListener() {
                ...
                intento.putExtra("numberSeats", (20 - pelicula.selectedSeats))
                intento.putExtra("posMovie", p0)
                intento.putExtra("seats", pelicula.selectedSeats)
